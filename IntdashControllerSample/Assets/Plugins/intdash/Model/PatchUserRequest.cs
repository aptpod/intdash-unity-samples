...
namespace intdash.Model
{
    ...
    public partial class PatchUserRequest : IEquatable<PatchUserRequest>
    {
        /// <summary>
        ...
        public PatchUserRequest(string name = default(string), string nickname = default(string), string description = default(string))
        {
            this.Name = name;
