...
namespace intdash.Model
{
    ...
    public partial class JobList : IEquatable<JobList>
    {
        /// <summary>
        ...
        public JobList(List<Job> items = default(List<Job>), decimal totalCount = default(decimal))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for JobList and cannot be null");
            }
            this.Items = items;
