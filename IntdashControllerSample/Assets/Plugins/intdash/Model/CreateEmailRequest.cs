...
namespace intdash.Model
{
    ...
    /// CreateEmailRequest
    /// </summary>
    [DataContract(Name = "CreateEmailRequest")]
    public partial class CreateEmailRequest : IEquatable<CreateEmailRequest>
    {
        ...
        public CreateEmailRequest(string address = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for CreateEmailRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as CreateEmailRequest);
        }

        /// <summary>
        /// Returns true if CreateEmailRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateEmailRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateEmailRequest input)
        {
            if (input == null)
            {
                return false;
