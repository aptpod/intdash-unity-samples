...
namespace intdash.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EdgeConnectionList_page")]
    public partial class EdgeConnectionListPage : IEquatable<EdgeConnectionListPage>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdgeConnectionListPage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdgeConnectionListPage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdgeConnectionListPage" /> class.
        /// </summary>
        ...
        /// <param name="previous">前のページのパス。現在のページが最初のページの場合は空文字列です。 (required).</param>
        /// <param name="totalCount">取得対象の総件数 (required).</param>
        public EdgeConnectionListPage(bool first = default(bool), bool last = default(bool), string next = default(string), string previous = default(string), int totalCount = default(int))
        {
            this.First = first;
            this.Last = last;
            ...
            if (next == null)
            {
                throw new ArgumentNullException("next is a required property for EdgeConnectionListPage and cannot be null");
            }
            this.Next = next;
            // to ensure "previous" is required (not null)
            if (previous == null)
            {
                throw new ArgumentNullException("previous is a required property for EdgeConnectionListPage and cannot be null");
            }
        ...
        /// </summary>
        /// <value>前のページのパス。現在のページが最初のページの場合は空文字列です。</value>
        ...
        {
            return this.Equals(input as EdgeConnectionListPage);
        }

        /// <summary>
        /// Returns true if EdgeConnectionListPage instances are equal
        /// </summary>
        /// <param name="input">Instance of EdgeConnectionListPage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdgeConnectionListPage input)
        {
            if (input == null)
            {
                return false;
