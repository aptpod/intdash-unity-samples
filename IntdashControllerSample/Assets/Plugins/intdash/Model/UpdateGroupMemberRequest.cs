...
namespace intdash.Model
{
    ...
    public partial class UpdateGroupMemberRequest : IEquatable<UpdateGroupMemberRequest>
    {
        /// <summary>
        ...
        public UpdateGroupMemberRequest(List<string> roleUuids = default(List<string>))
        {
