...
namespace intdash.Model
{
    ...
    public partial class Users : IEquatable<Users>
    {
        ...
        public Users(List<User> items = default(List<User>), AuthPage page = default(AuthPage))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for Users and cannot be null");
            }
            this.Items = items;
            // to ensure "page" is required (not null)
            if (page == null)
            {
                throw new ArgumentNullException("page is a required property for Users and cannot be null");
            }
            this.Page = page;
        }
