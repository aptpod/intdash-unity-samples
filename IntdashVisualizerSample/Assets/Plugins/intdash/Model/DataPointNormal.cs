...
namespace intdash.Model
{
    ...
    /// 改行で区切られたJSON文字列です。
    /// </summary>
    [DataContract(Name = "DataPointNormal")]
    public partial class DataPointNormal : IEquatable<DataPointNormal>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataPointNormal" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DataPointNormal() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DataPointNormal" /> class.
        /// </summary>
        ...
        public DataPointNormal(DataPointTime time = default(DataPointTime), string measurementUuid = default(string), string createdAt = default(string), string dataType = default(string), string dataId = default(string), Object data = default(Object))
        {
            ...
            if (time == null)
            {
                throw new ArgumentNullException("time is a required property for DataPointNormal and cannot be null");
            }
            this.Time = time;
            // to ensure "measurementUuid" is required (not null)
            if (measurementUuid == null)
            {
                throw new ArgumentNullException("measurementUuid is a required property for DataPointNormal and cannot be null");
            }
            this.MeasurementUuid = measurementUuid;
            // to ensure "createdAt" is required (not null)
            if (createdAt == null)
            {
                throw new ArgumentNullException("createdAt is a required property for DataPointNormal and cannot be null");
            }
            this.CreatedAt = createdAt;
            // to ensure "dataType" is required (not null)
            if (dataType == null)
            {
                throw new ArgumentNullException("dataType is a required property for DataPointNormal and cannot be null");
            }
            this.DataType = dataType;
            // to ensure "dataId" is required (not null)
            if (dataId == null)
            {
                throw new ArgumentNullException("dataId is a required property for DataPointNormal and cannot be null");
            }
            this.DataId = dataId;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for DataPointNormal and cannot be null");
            }
            this.Data = data;
        }
        ...
        /// </summary>
        /// <value>データのペイロード。ペイロードのJSON表現はデータタイプによって異なります。 [詳説iSCP 1.0](https://docs.intdash.jp/manual/iscp1-essentials/latest/ja/iscp1-essentials-ja.pdf) の「付録: データタイプとペイロードの定義」を参照してください。 iscpv1に当てはまらない場合、下記のフォーマットで固定となります。  &#x60;&#x60;&#x60; {   \&quot;d\&quot;: \&quot;データ本体のBase64表記\&quot; } &#x60;&#x60;&#x60;</value>
        ...
        {
            return this.Equals(input as DataPointNormal);
        }

        /// <summary>
        /// Returns true if DataPointNormal instances are equal
        /// </summary>
        /// <param name="input">Instance of DataPointNormal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataPointNormal input)
        {
            if (input == null)
            {
                return false;
