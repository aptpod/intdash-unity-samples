...
namespace intdash.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddGroupMemberRequest")]
    public partial class AddGroupMemberRequest : IEquatable<AddGroupMemberRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddGroupMemberRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddGroupMemberRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddGroupMemberRequest" /> class.
        /// </summary>
        ...
        /// <param name="roleUuids">ユーザーに割り当てるロールのUUID。オーナーのロールUUIDは変更できません。 (required).</param>
        public AddGroupMemberRequest(string userEmailAddress = default(string), string userUuid = default(string), List<string> roleUuids = default(List<string>))
        {
            // to ensure "roleUuids" is required (not null)
            if (roleUuids == null)
            {
                throw new ArgumentNullException("roleUuids is a required property for AddGroupMemberRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>ユーザーに割り当てるロールのUUID。オーナーのロールUUIDは変更できません。</value>
        ...
        {
            return this.Equals(input as AddGroupMemberRequest);
        }

        /// <summary>
        /// Returns true if AddGroupMemberRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AddGroupMemberRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddGroupMemberRequest input)
        {
            if (input == null)
            {
                return false;
