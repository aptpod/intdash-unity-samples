...
namespace intdash.Model
{
    ...
    /// CreateSignalRequest
    /// </summary>
    [DataContract(Name = "CreateSignalRequest")]
    public partial class CreateSignalRequest : IEquatable<CreateSignalRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSignalRequest" /> class.
        /// </summary>
        ...
        /// <param name="uuid">信号定義のUUID.</param>
        public CreateSignalRequest(int channel = default(int), SignalConversion conversion = default(SignalConversion), string dataId = default(string), int dataType = default(int), string description = default(string), SignalDisplay display = default(SignalDisplay), string label = default(string), string uuid = default(string))
        {
        ...
        {
            return this.Equals(input as CreateSignalRequest);
        }

        /// <summary>
        /// Returns true if CreateSignalRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateSignalRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSignalRequest input)
        {
            if (input == null)
            {
                return false;
