...
namespace intdash.Model
{
    ...
    /// EdgeConnection
    /// </summary>
    [DataContract(Name = "EdgeConnection")]
    public partial class EdgeConnection : IEquatable<EdgeConnection>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdgeConnection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdgeConnection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdgeConnection" /> class.
        /// </summary>
        ...
        public EdgeConnection(string uuid = default(string), string lastLivedAt = default(string), EdgeConnectionEdge edge = default(EdgeConnectionEdge), string createdAt = default(string), string updatedAt = default(string), List<EdgeConnectionDownstream> downstreams = default(List<EdgeConnectionDownstream>), List<EdgeConnectionUpstream> upstreams = default(List<EdgeConnectionUpstream>))
        {
            // to ensure "uuid" is required (not null)
            if (uuid == null)
            {
                throw new ArgumentNullException("uuid is a required property for EdgeConnection and cannot be null");
            }
            this.Uuid = uuid;
            // to ensure "lastLivedAt" is required (not null)
            if (lastLivedAt == null)
            {
                throw new ArgumentNullException("lastLivedAt is a required property for EdgeConnection and cannot be null");
            }
            this.LastLivedAt = lastLivedAt;
            // to ensure "edge" is required (not null)
            if (edge == null)
            {
                throw new ArgumentNullException("edge is a required property for EdgeConnection and cannot be null");
            }
            this.Edge = edge;
            // to ensure "createdAt" is required (not null)
            if (createdAt == null)
            {
                throw new ArgumentNullException("createdAt is a required property for EdgeConnection and cannot be null");
            }
            this.CreatedAt = createdAt;
            // to ensure "updatedAt" is required (not null)
            if (updatedAt == null)
            {
                throw new ArgumentNullException("updatedAt is a required property for EdgeConnection and cannot be null");
            }
            this.UpdatedAt = updatedAt;
            // to ensure "downstreams" is required (not null)
            if (downstreams == null)
            {
                throw new ArgumentNullException("downstreams is a required property for EdgeConnection and cannot be null");
            }
            this.Downstreams = downstreams;
            // to ensure "upstreams" is required (not null)
            if (upstreams == null)
            {
                throw new ArgumentNullException("upstreams is a required property for EdgeConnection and cannot be null");
            }
        ...
        {
            return this.Equals(input as EdgeConnection);
        }

        /// <summary>
        /// Returns true if EdgeConnection instances are equal
        /// </summary>
        /// <param name="input">Instance of EdgeConnection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdgeConnection input)
        {
            if (input == null)
            {
                return false;
