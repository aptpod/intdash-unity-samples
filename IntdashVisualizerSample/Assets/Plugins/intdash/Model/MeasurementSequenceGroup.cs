...
namespace intdash.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MeasurementSequenceGroup")]
    public partial class MeasurementSequenceGroup : IEquatable<MeasurementSequenceGroup>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeasurementSequenceGroup" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MeasurementSequenceGroup() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MeasurementSequenceGroup" /> class.
        /// </summary>
        /// <param name="uuid">計測シーケンスのUUID (required).</param>
        ...
        public MeasurementSequenceGroup(string uuid = default(string), long expectedDataPoints = default(long), long finalSequenceNumber = default(long), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            // to ensure "uuid" is required (not null)
            if (uuid == null)
            {
                throw new ArgumentNullException("uuid is a required property for MeasurementSequenceGroup and cannot be null");
            }
            this.Uuid = uuid;
        ...
        {
            return this.Equals(input as MeasurementSequenceGroup);
        }

        /// <summary>
        /// Returns true if MeasurementSequenceGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of MeasurementSequenceGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeasurementSequenceGroup input)
        {
            if (input == null)
            {
                return false;
