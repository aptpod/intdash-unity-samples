...
namespace intdash.Model
{
    ...
    public partial class Projects : IEquatable<Projects>
    {
        ...
        public Projects(List<Project> items = default(List<Project>), AuthPage page = default(AuthPage))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for Projects and cannot be null");
            }
            this.Items = items;
            this.Page = page;
        }
