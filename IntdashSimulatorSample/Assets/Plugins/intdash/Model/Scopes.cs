...
namespace intdash.Model
{
    ...
    public partial class Scopes : IEquatable<Scopes>
    {
        ...
        public Scopes(List<Scope> items = default(List<Scope>), AuthPage page = default(AuthPage))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for Scopes and cannot be null");
            }
            this.Items = items;
            // to ensure "page" is required (not null)
            if (page == null)
            {
                throw new ArgumentNullException("page is a required property for Scopes and cannot be null");
            }
            this.Page = page;
        }
        ...
        public List<Scope> Items { get; set; }
