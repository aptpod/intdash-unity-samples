...
namespace intdash.Model
{
    ...
    public partial class Groups : IEquatable<Groups>
    {
        ...
        public Groups(List<Group> items = default(List<Group>), AuthPage page = default(AuthPage))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for Groups and cannot be null");
            }
            this.Items = items;
            this.Page = page;
        }
