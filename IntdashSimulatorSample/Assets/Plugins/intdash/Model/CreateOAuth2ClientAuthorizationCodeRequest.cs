...
namespace intdash.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateOAuth2ClientAuthorizationCodeRequest")]
    public partial class CreateOAuth2ClientAuthorizationCodeRequest : IEquatable<CreateOAuth2ClientAuthorizationCodeRequest>
    {
        /// <summary>
        /// グラントタイプ
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOAuth2ClientAuthorizationCodeRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateOAuth2ClientAuthorizationCodeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOAuth2ClientAuthorizationCodeRequest" /> class.
        /// </summary>
        ...
        public CreateOAuth2ClientAuthorizationCodeRequest(string name = default(string), GrantTypeEnum grantType = default(GrantTypeEnum), List<string> redirectUris = default(List<string>), TokenEndpointAuthMethodEnum tokenEndpointAuthMethod = TokenEndpointAuthMethodEnum.ClientSecretPost, string tlsClientAuthSubjectDn = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateOAuth2ClientAuthorizationCodeRequest and cannot be null");
            }
            this.Name = name;
            ...
            {
                throw new ArgumentNullException("redirectUris is a required property for CreateOAuth2ClientAuthorizationCodeRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as CreateOAuth2ClientAuthorizationCodeRequest);
        }

        /// <summary>
        /// Returns true if CreateOAuth2ClientAuthorizationCodeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateOAuth2ClientAuthorizationCodeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateOAuth2ClientAuthorizationCodeRequest input)
        {
            if (input == null)
            {
                return false;
