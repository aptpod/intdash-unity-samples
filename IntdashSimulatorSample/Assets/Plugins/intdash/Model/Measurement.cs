...
namespace intdash.Model
{
    ...
    public partial class Measurement : IEquatable<Measurement>
    {
        ...
        public Measurement(string uuid = default(string), string name = default(string), string description = default(string), string basetime = default(string), MeasurementBaseTimeType basetimeType = default(MeasurementBaseTimeType), string edgeUuid = default(string), long duration = default(long), long maxElapsedTime = default(long), bool completed = default(bool), bool _protected = default(bool), MeasurementSequencesSummary sequences = default(MeasurementSequencesSummary), List<MeasurementMarker> markers = default(List<MeasurementMarker>), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), decimal processedRatio = default(decimal), bool ended = default(bool), StatusEnum status = default(StatusEnum))
        {
            // to ensure "uuid" is required (not null)
            if (uuid == null)
            {
                throw new ArgumentNullException("uuid is a required property for Measurement and cannot be null");
            }
            this.Uuid = uuid;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for Measurement and cannot be null");
            }
            this.Name = name;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for Measurement and cannot be null");
            }
            this.Description = description;
            // to ensure "basetime" is required (not null)
            if (basetime == null)
            {
                throw new ArgumentNullException("basetime is a required property for Measurement and cannot be null");
            }
            ...
            if (edgeUuid == null)
            {
                throw new ArgumentNullException("edgeUuid is a required property for Measurement and cannot be null");
            }
            this.EdgeUuid = edgeUuid;
            this.Duration = duration;
            this.Protected = _protected;
            // to ensure "sequences" is required (not null)
            if (sequences == null)
            {
                throw new ArgumentNullException("sequences is a required property for Measurement and cannot be null");
            }
        ...
        /// </summary>
        /// <value>&#x60;true&#x60; の場合、この計測はサーバーへのデータの回収が完了しています。</value>
        ...
        /// </summary>
        [DataMember(Name = "sequences", IsRequired = true, EmitDefaultValue = true)]
        public MeasurementSequencesSummary Sequences { get; set; }

        /// <summary>
        /// Gets or Sets Markers
        /// </summary>
        [DataMember(Name = "markers", EmitDefaultValue = false)]
        public List<MeasurementMarker> Markers { get; set; }
        ...
        /// </summary>
        /// <value>代わりに &#x60;sequences.received_chunks_ratio&#x60; を使用してください。処理済み率を表します。</value>
        ...
        public bool Equals(Measurement input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.Sequences != null &&
                    this.Sequences.Equals(input.Sequences))
                ) && 
                (
                    this.Markers == input.Markers ||
                    this.Markers != null &&
                    input.Markers != null &&
                    this.Markers.SequenceEqual(input.Markers)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.Markers.GetHashCode();
                }
